...
bool core__msg__command_user__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("core.msg._command_user.CommandUser", full_classname_dest, 34) == 0);
  }
  core__msg__CommandUser * ros_message = _ros_message;
  {  // odom
  ...
  {  // event
    ...
    if (!core__msg__event_user__convert_from_py(field, &ros_message->event)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CommandUser */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("core.msg._command_user");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CommandUser");
  ...
  {  // event
    PyObject * field = NULL;
    field = core__msg__event_user__convert_to_py(&ros_message->event);
    if (!field) {
      return NULL;
    }
    {
