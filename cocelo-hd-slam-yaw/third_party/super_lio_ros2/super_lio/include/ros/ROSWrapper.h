...
private:
  ...
  // The world cloud and odometry are estimates at a LiDAR measurement time.
  // Publish TF at that same time; assigning wall-clock time to an older pose
  // makes consumers transform a cloud with the pose from a different scan.
...
private:
  ...
  rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pub_map_odom_;   /// corrected map-frame pose
