...
namespace LI2Sup{
  ...
  extern double g_slam_max_correction_translation;
  extern double g_slam_max_correction_rotation_deg;
  ...
  extern double g_imu_init_acc_norm_tolerance;
  extern double g_imu_init_acc_std_threshold;
  extern double g_imu_init_gyro_threshold;
  extern double g_imu_init_gyro_std_threshold;
  ...
  extern double g_kf_max_scan_correction_translation;
  extern double g_kf_max_scan_correction_rotation_deg;
  ...
  extern bool g_publish_global_map;
